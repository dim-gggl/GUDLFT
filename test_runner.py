...
def run_test_save_competitions_data():
    """Test spécifique pour save_competitions_data"""
    try:
        from tests.unit_tests.test_data_manager import test_save_competitions_data
...
def run_test_update_existing_club_and_competition():
    """Test pour update_existing_club_and_competition"""
    try:
        from tests.unit_tests.test_data_manager import test_update_existing_club_and_competition
...
def run_test_booking_with_validation_error():
    """Test pour booking_with_validation_error"""
    try:
        from tests.unit_tests.test_data_manager import test_booking_with_validation_error
