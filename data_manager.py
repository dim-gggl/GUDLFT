...
def save_clubs_and_competitions(app_instance: Flask, clubs: list, competitions: list):
...
def update_data_after_booking(competition: dict, club: dict, places_required: int) -> str | None:
    """
